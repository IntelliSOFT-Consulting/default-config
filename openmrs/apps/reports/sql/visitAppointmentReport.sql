SELECT DISTINCT 
	 ...
	 patientVisit.visitStartDate AS 'Visit Date',
	 patientVisit.visitType AS 'Visit Type',
...
WHERE pa.status IN ('CheckedIn', 'Completed') AND 
pa.start_date_time BETWEEN '#startDate#' AND '#endDate#' 
